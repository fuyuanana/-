...
define(function (require) {
    ...
    Echarts.prototype = {
        ...
        /**
         * 万能接口，配置图表实例任何可配置选項，多次调用时option选項做merge处理
         * @param {Object} option
         * @param {boolean=} notMerge 多次调用时option选項是默认是合并（merge）的，
        ...
        /**
         * timelineOption接口，配置图表实例任何可配置选項
         * @param {Object} option
         */
         ...
         * 动态[标注 | 标线]删除
         * @param {number} seriesIdx 系列索引
         * @param {string} markName [标注 | 标线]名稱
         */
